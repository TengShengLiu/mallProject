...
<html>
	<head>
		...
		<script type="text/javascript" src="${path}/static/js/balance.js"></script>
	</head>
	<body>
	<!-- start header -->
	<!--end header -->
...
<!-- start banner_x -->
		...
		<div class="gwcxqbj">
			<div class="gwcxd center">
				...
				<c:forEach items="${requestScope.balanceList}" var="product" varStatus="abc">
					<div class="content2 center">
						...
						<div class="sub_content fl">
							<input class="shuliang" id="count${abc.count}" type="number" readonly="readonly" value="${product.count}" step="1" min="1"/>
						</div>
			...
			<div class="jiesuandan mt20 center">
				...
				<div class="jiesuan fr">
					...
					<div class="jsanniu fr"><input class="jsan" type="button" name="jiesuan" onclick="balance(${requestScope.i},${requestScope.total})" value="结算"/></div>
					<div class="clear"></div>
				</div>
				<div class="clear"></div>
			</div>
