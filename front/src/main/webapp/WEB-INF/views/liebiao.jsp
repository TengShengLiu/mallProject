			...
			<div class="main center">
				...
				<c:forEach items="${requestScope.products}" var="product">
					<div class="mingxing fl mb20" style="border:2px solid #fff;width:230px;cursor:pointer;" onmouseout="this.style.border='2px solid #fff'" onmousemove="this.style.border='2px solid red'">
						<div class="sub_mingxing"><a href="${path}/product/getProductInfo?pid=${product.pid}" target="_blank"><img src="${path}/${product.url}" alt=""></a></div>
						<div class="pinpai"><a href="${path}/product/getProductInfo?pid=${product.pid}" target="_blank">${product.pName}</a></div>
				...
				<%--<div class="mingxing fl mb20" style="border:2px solid #fff;width:230px;cursor:pointer;" onmouseout="this.style.border='2px solid #fff'" onmousemove="this.style.border='2px solid red'">
					<div class="sub_mingxing"><a href="./xiangqing.html" target="_blank"><img src="${path}/static/image/liebiao_xiaomi6.jpg" alt=""></a></div>
